...
if (isset($_GET['editar'])){
    $usuarios = CadastroController::getInstance()->getusuarios($_GET['editar']);
}

if (isset($_POST['enviar'])){
    $usuarios->setLogin($_POST['login']);
    $usuarios->setSenha($_POST['senha']);
    if(CadastroController::getInstance()->gravar($usuarios)){
            ...
            <div class="container-fluid">
                <form action="#" method="post">
                    <div class="mb-3">
                        ...
                        <input type="text" name="login" id="login" class="form-control" value="<?php echo $usuarios->getlogin();?>">
                    </div>
                    <div class="mb-3">
                        <label for="senha">Senha:</label>
                        <input type="text" name="senha" id="Senha" class="form-control" value="<?php echo $usuarios->getSenha();?>">
                    </div>
                    <div class="mb-3">
                        <input class="btn btn-primary" type="submit" value="Salvar" name="enviar">
                        <a href="viewCadastro.php" class="btn btn-danger">Cancelar</a>
                    </div>
                </form>
            </div>
        </main>
